...
class MyColor {
  ...
  static const Color darkPrimary = const Color(0x33000000);
  static const Color darkSub = const Color(0xFF000000);
  static const Color darkContainer = const Color(0xFF1A1A1A);
  static const Color outLine = const Color(0x1F000000);
  static const Color white = const Color(0xFFFFFFFF);
  static const Color whiteSub = const Color(0x33FFFFFF);
