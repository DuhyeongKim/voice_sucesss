...
class AudioController extends GetxController{
  ...
  removeChannelInFirebase(){
    firebaseFirestore.collection("channelName").doc(channelName.text).delete();
  }
  ...
  void setClientRole(ClientRole role) async{
    await engine.setClientRole(role);
  }

  void muteLocalAudioStream(bool muted) async {
